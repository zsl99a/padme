...
| 启动成本(技能) | 7(写作基本功 + LLM 流水线) | 0.05 | 0.35 |
| 首笔收入速度 | 5(需 3-6 月积累订户) | 0.15 | 0.75 |
| 可扩展性 | 8(边际成本低) | 0.10 | 0.80 |
| 可持续性 | 8(订阅制) | 0.10 | 0.80 |
| 自动化程度 | 8 | 0.15 | 1.20 |
| 风险 | 8.1(拆分:法律 10 × 0.5 + ToS 7 × 0.3 + 市场 5 × 0.2 = 8.1) | 0.15 | 1.22 |
| 证据强度 | 7(Substack 数据公开) | 0.15 | 1.05 |
| + 现实数据奖励 | +0.5(Substack leaderboard 月入 $10K-$100K 多案例) | — | +0.50 |
| **总分** | — | — | **8.2** |
