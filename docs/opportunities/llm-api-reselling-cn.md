...
| 维度 | 分数(0-10) | 权重 | 加权 |
| --- | --- | --- | --- |
| 启动成本(资金) | 9(几乎 0;只需一台 VPS) | 0.10 | 0.90 |
| 启动成本(技能) | 7(会 Docker + Linux 基础即可) | 0.10 | 0.70 |
| 首笔收入速度 | 9(V2EX 上一发帖即有交易) | 0.15 | 1.35 |
| 可扩展性 | 8(账号池可横向扩) | 0.15 | 1.20 |
| 可持续性 | 5(上游随时变,1-2 年内可能被官方 API 直连替代) | 0.15 | 0.75 |
| 自动化程度 | 7(部署+计费全自,流量仍半人工) | 0.15 | 1.05 |
| 风险 | 4(违反 OpenAI/Anthropic ToS,可能被封) | 0.10 | 0.40 |
| 证据强度 | 9(V2EX 多帖讨论 + 商品已大量存在) | 0.10 | 0.90 |
| **总分** | — | — | **7.25** |
