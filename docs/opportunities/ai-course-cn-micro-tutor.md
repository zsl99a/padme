...
| 证据强度 | **7**(李一舟 1.75 亿作废,只剩粥左罗 1 个 2023 案例) | 0.15 | 1.05 |
| + 现实数据奖励 | 粥左罗 17 天 279 万(1 个明确收入案例 2023 旧闻)= **+0.30** | — | +0.30 |
| gray 突破封顶 +0.5(达到 $1k+ 月入门槛) | — | — | +0.50 |
| **总分** | — | — | **7.43 ≈ 7.4** |

决策:**排队**(原"观察中 parking-lot 备选"上调到"排队";gray 突破封顶案例,但分数明显下调)
...
- **同质化**:粥左罗等已被大量模仿,新进入者必须有差异化(技术深度 / 行业资源 / 私域沉淀)。
...
1. [36 氪 - 三年狂赚 1.75 亿,卖课,才是中国 AI 最容易赚钱的生意](https://m.36kr.com/p/3233572902108801) — authoritative-media — 抓取:2026-06-05
   > ⚠️ **李一舟案例作废**:李一舟 2024-02 因**虚假宣传被罚 5000 万 + 课程下架 + 盗用近百个 AI 模型指控**(OFweek / 证券时报 / 投中网 多源);**已不可作为可复制案例**(原档"李一舟 1.75 亿"已删除);"在中国,AI 的 C 端市场,恐怕没有比卖课更好地商业模式了" — 这条判断本身仍有效
2. [OFweek - 中国 AI"先行者"李一舟 2024-02](https://m.ofweek.com/ai/2024-02/ART-201700-8470-30626950.html) — authoritative-media — 抓取:2026-06-05
   > "AI 课程虚假宣传被罚 5000 万元,盗用近百个 AI 模型" — **李一舟案例历史教训**
3. [网易 - 早知道卖 AI 课这么赚,我还上什么班](https://www.163.com/dy/article/KRBJP6PP051181GK.html) — authoritative-media — 抓取:2026-06-05
   > "粥左罗在知识星球上推出《ChatGPT AI 变现圈》,17 天斩获 279 万销售额"(2023 旧闻,模式有效证据)
4. [小报童排行榜 - 最高订阅 (osguider 第三方数据)](https://xiaobot.osguider.com/sort/subscriber-count/) — aggregator — 抓取:2026-06-05
   > 「产品经理学技术」订阅 331、「小红书爆款笔记 1000 篇」订阅 218 等真实榜数据,印证小报童仍活跃。
5. [知乎专栏 - 小报童是什么?小报童专栏怎么赚钱?](https://zhuanlan.zhihu.com/p/718582018) — community — 抓取:2026-06-05
