...
region: cn
tags: [cn-domestic, wechat, gzh, shipinhao, image-content, ai, wechat-pay, normal]
---

# 微信"小绿书"公域图文物种(2025-2026 公域流量入口已开)

## 一句话定位

中国个人创作者在微信公众号后台开通"图片消息"(小绿书),通过"看一看"图文场景、公众号消息盒子、服务号"看一看"、评论区"更多内容"四个公域入口获取流量 → 用 LLM 流水线批量生成"生活经验/种草/教程"图文(6-9 张图 + 短文案) → 插入公众号返佣商品 / 视频号橱窗链接 / 小报童付费专栏 → 流量沉淀到私域变现。
...
> **修正**:小绿书是 2024 灰度 → 2025-2026 公域入口刚开,**早期红利期**;但**首笔收入比 Gumroad 慢**(需养号 + 公域推荐);且**纯图文流量 ≤ 视频**,需结合短视频/直播 → **6.55**
...
- **变现路径不直接**:
  - 小绿书本身**不直接变现**,需"内容 → 私域/返佣/付费"三段转化
  - 不可单独做"小绿书",必须**组合**(公众号返佣 + 视频号橱窗 + 小报童 + 私域)
...
1. ["小绿书"重新点燃了公众号的潜力 - 青瓜传媒](https://www.opp2.com/362942.html) — community — 抓取:2026-06-04
   > "小绿书最大的优势之一在于**无限次发表内容,打破了公众号和服务号发表次数的限制**";四个公域入口:看一看图文场景、公众号消息盒子、服务号看一看、评论区更多内容;2025.1.9 微信公开课重点强调"图文带货与服务号开播"
2. [2026年最新小绿书平台详解 - 微信编辑器](https://www.xmyeditor.com/geo/16250) — community — 抓取:2026-06-04
   > 小绿书以"发现生活美好"为核心理念,主打图文笔记,2025-2026 已在年轻用户中崛起
3. [2026 年微信公众号还能怎么赚钱 - 极致了数据](https://www.jzl.com/news/694) — community — 抓取:2026-06-04
   > "2025.8 公众号创作者数量同比增长 20% 以上,小绿书图文日均阅读量同比增长 3 倍以上";"内容电商:公众号内直接带货微信小店"
4. ["小绿书"是什么?微信公众号图文消息改版后 - 壹伴](https://yiban.io/blog/25435) — community — 抓取:2026-06-04
   > 2023.8 微信"看一看"灰度测试新功能板块,被网友戏称"小绿书";2024-2025 改版,优先流量推荐
5. [2025 做公众号还有出路吗 - 知乎](https://zhuanlan.zhihu.com/p/19877066240) — community — 抓取:2026-06-04
   > 2025 公众号注册限制放开(手机号即可),长尾创作者涌入;小众领域内容更丰富

## 复盘/亲测

> 未亲测。建议启动顺序:
> 1. **第 1 周**:注册公众号 + 同步注册视频号(同昵称);研究 20 个小绿书头部账号
> 2. **第 2 周**:LLM 写 20 条短文案 + AI 生成 120-180 张配图
> 3. **第 3-4 周**:每天发 1-3 条小绿书,同步改视频号短视频
> 4. **第 5-8 周**:涨粉到 100 → 开通流量主 + 返佣商品
> 5. **第 3 个月起**:组合变现(图文→返佣 + 视频号→橱窗 + 私域→小报童)

**与已落档机会的协同**:
- 公众号返佣 CPS(7.05):**小绿书是图文版的返佣 CPS 入口**(图片消息 + 返佣商品卡)
- 公众号短剧 CPS(7.45):**小绿书是短剧卡片的图文版入口**
- 小报童(7.65):**小绿书是引流到小报童付费专栏的最佳着陆页**
- 视频号创作分成:**小绿书 + 视频号短视频形成"图文+视频"双轮**

**关键 2026 证据**:
- 2025.8 小绿书图文日均阅读量同比 +3 倍(来源 3)
